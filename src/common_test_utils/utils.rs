...
use crate::{api::dto::Credentials, kube_types::{SbomReport, VulnerabilityReport}};
...
pub const VULNERABILITY_REPORT_GVK: LazyLock<GroupVersionKind> =
    LazyLock::new(|| GroupVersionKind::gvk(VULNERABILITY_REPORT_GROUP, VULNERABILITY_REPORT_VERSION, VULNERABILITY_REPORT_KIND));
...
pub const SBOM_REPORT_GVK: LazyLock<GroupVersionKind> =
    LazyLock::new(|| GroupVersionKind::gvk(SBOM_REPORT_GROUP, SBOM_REPORT_VERSION, SBOM_REPORT_KIND));
